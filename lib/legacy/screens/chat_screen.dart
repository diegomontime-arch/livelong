...
/// Worker Anthropic — sem API key no cliente (sem header x-api-key).
const _kAnaMessagesUrl = 'https://hitlook-ana-proxy.hitlook.workers.dev/v1/messages';
const _kAnaModel = 'claude-sonnet-4-6';
...
''';
  ...
  /// Sugestões educacionais para iniciar a conversa com a Ana.
  ///
  /// **Nota legal (LEGAL.md §2.2):** evitamos sugestões que induzam o
  /// prospect a compartilhar dados de saúde (ex: "Tengo una condición
  /// preexistente"). Dados médicos são classificados como Sensitive PII
  /// sob CCPA/CPRA e como "nonpublic personal health information" sob
  /// NAIC Model 670 (adotado por FL em §626.9651). Saúde deve ser
  /// discutida com o agente licenciado por canal apropriado, não com
  ...
  /// (planning/LEGAL.md §6, planning/RISKS.md R1).
  String _disclaimerText() {
    switch (widget.lang) {
      case 'es':
        return 'Educación financiera general. No es asesoramiento de seguros.';
      case 'en':
        return 'General financial education. Not insurance advice.';
      default:
        return 'Educação financeira geral. Não é aconselhamento de seguros.';
    }
  }
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              // Visível e sempre presente; obrigatório por LEGAL.md §6.
              Container(
